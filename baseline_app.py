# ===========================================================================================
# RESEARCH CENTER CLASSIFICATION API
# Derived from Baseline Clustering Model: EDA_and_Model.ipynb
# ============================================================================================
...
kmeans = joblib.load("baseline_models/kmeans_model.pkl")
scaler = joblib.load("baseline_models/scaler.pkl")
cluster_to_tier = joblib.load("baseline_models/cluster_to_tier.pkl")
